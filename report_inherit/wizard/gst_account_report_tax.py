...
class AccountTaxReport(models.TransientModel):
    ...
    def check_report(self):
        data= {'model' : 'gst.account.tax.reports', 'form'  : self.read(['fiscal_year_from', 'fiscal_year_to','period_from','period_to'])[0], 'date_from' : 'none', 'date_to': 'none'}
        ...
        return self.env.ref('report_inherit.action_gst_report_account_tax').with_context(landscape=True).report_action(
            self, data=data)
